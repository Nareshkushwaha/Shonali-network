...
const AdminLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="bg-slate-50 font-body text-slate-900 antialiased flex min-h-screen relative">
      ...
      {/* Mobile Sidebar Overlay (Peeche ka kala dhundhla hissa) */}
      {isSidebarOpen && (
        <div 
      ...
      {/* 🔥 FIX: Sidebar ko transparent se hta kar solid 'bg-white' de diya */}
      <aside 
        className={`h-screen w-64 fixed left-0 top-0 bg-white flex flex-col py-6 z-50 shadow-2xl md:shadow-sm transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <nav className="flex-1 space-y-1 px-3 overflow-y-auto no-scrollbar">
          <Link to="/admin-dashboard" onClick={closeSidebar} className={`px-4 py-3 rounded-r-xl flex items-center gap-3 transition-transform ${location.pathname === "/admin-dashboard" ? "bg-blue-50 shadow-sm border-l-4 border-blue-600 text-blue-700 scale-[1.02]" : "text-slate-500 hover:text-blue-600 hover:bg-slate-50"}`}>
          ...
          <Link to="/admin-sub-services" onClick={closeSidebar} className={`px-4 py-3 rounded-r-xl flex items-center gap-3 transition-transform ${location.pathname === "/admin-sub-services" ? "bg-blue-50 shadow-sm border-l-4 border-blue-600 text-blue-700 scale-[1.02]" : "text-slate-500 hover:text-blue-600 hover:bg-slate-50"}`}>
          ...
          <Link to="/admin-projects" onClick={closeSidebar} className={`px-4 py-3 rounded-r-xl flex items-center gap-3 transition-transform ${location.pathname === "/admin-projects" ? "bg-blue-50 shadow-sm border-l-4 border-blue-600 text-blue-700 scale-[1.02]" : "text-slate-500 hover:text-blue-600 hover:bg-slate-50"}`}>
          ...
          <Link to="/admin-leads" onClick={closeSidebar} className={`px-4 py-3 rounded-r-xl flex items-center gap-3 transition-transform ${location.pathname === "/admin-leads" ? "bg-blue-50 shadow-sm border-l-4 border-blue-600 text-blue-700 scale-[1.02]" : "text-slate-500 hover:text-blue-600 hover:bg-slate-50"}`}>
          ...
          <Link to="/admin-brochures" onClick={closeSidebar} className={`px-4 py-3 rounded-r-xl flex items-center gap-3 transition-transform ${location.pathname === "/admin-brochures" ? "bg-blue-50 shadow-sm border-l-4 border-blue-600 text-blue-700 scale-[1.02]" : "text-slate-500 hover:text-blue-600 hover:bg-slate-50"}`}>
          ...
          <Link to="/admin-settings" onClick={closeSidebar} className={`px-4 py-3 rounded-r-xl flex items-center gap-3 transition-transform mt-auto ${location.pathname === "/admin-settings" ? "bg-blue-50 shadow-sm border-l-4 border-blue-600 text-blue-700 scale-[1.02]" : "text-slate-500 hover:text-blue-600 hover:bg-slate-50"}`}>
